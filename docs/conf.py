...
version = pyldap.__version__
# The full version, including alpha/beta/rc tags.
release = pyldap.__version__
...
latex_documents = [
  ('index', 'pyldap.tex', 'pyldap Documentation',
   'noirello', 'manual'),
]
...
man_pages = [
    ('index', 'pyldap', 'pyldap Documentation',
     ['noirello'], 1)
]
...
texinfo_documents = [
  ('index', 'pyldap', 'pyldap Documentation',
   'noirello', 'pyldap', 'One line description of project.',
   'Miscellaneous'),
]
